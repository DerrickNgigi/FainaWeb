...
@section('content')
    ...
    <div class="page-title-area pos-relative gray-bg pt-90 pb-20 fix" style="background-image: url(img/bg/page-title-bg.jpg);">
            ...
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="page-title mb-30">
                        <h3>About Us</h3>
                        <p>Inspired by the necessity to innovate.</p>
                    </div>
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="soft-fea-list text-center mb-30">
                        ...
                        <p>Stars air over land bring life female stars dry be abundantly may green te which fill after our
                            behold very god spir.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
                    <div class="soft-fea-list text-center mb-30">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="logo-brand-item">
                    <div class="brand-img">
                        <a href="#"><img src="img/brand/01.png" alt=""></a>
                    </div>
                </div>
                <div class="logo-brand-item">
                    <div class="brand-img">
                        <a href="#"><img src="img/brand/03.png" alt=""></a>
                    </div>
                </div>
                <div class="logo-brand-item">
                    <div class="brand-img">
                        <a href="#"><img src="img/brand/04.png" alt=""></a>
                    </div>
                </div>
                <div class="logo-brand-item">
                    <div class="brand-img">
                        <a href="#"><img src="img/brand/05.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
