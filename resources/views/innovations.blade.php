            ...
            <div class="row align-items-center">
                <div class="col-lg-6 ">
                    <div class="page-title mb-30">
                        <h3  style="color: white">Faina Innovations</h3>
                        <p  style="color: white" >Inspired to innovate solutions in Agriculture and Education. Rewriting the story of Africa. </p>
                    </div>
                </div>
                <div class="col-lg-6">
                ...
                <div class="col-12">
                    <div class="xn-portfolio">
                        <div class="xn-portfolio-thumb grad-overlay">
                            <img src="img/portfolio/m-06.png" alt="">
                            <div class="port-view">
{{--                                <a class="popup-image" href="img/portfolio/m-01.jpg"><i class="far fa-search"></i></a>--}}
                ...
                <div class="col-12">
                    <div class="xn-portfolio">
                        <div class="xn-portfolio-thumb grad-overlay">
                            <img src="img/portfolio/m-01.jpeg" alt="">
                            <div class="port-view">
                                <a class="popup-image" href="img/portfolio/m-01.jpeg"><i class="far fa-search"></i></a>
                                <a class="port-link" href="{{route("fainaAgriculture")}}"><i class="far fa-link"></i></a>
                                <div></div>
                                <h3>Shamba Assistant</h3>
                            </div>
                        </div>
                    </div>
                </div>
